...
class CopyIndexController extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        return view('web.home.copyIndex', compact('calender','year','homeSlider','rounds','clients','partners','btsNumbers','trainers','venues','subCategories'));
    }
