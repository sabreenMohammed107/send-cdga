				...
				<div class="col-sm-12">
					...
					<div class="col-lg-2 col-md-4 col-sm-12">
						...
						<ul class="nav nav-tabs tabs-left sideways list-group">
							...
							<li class="active"><a href="{{ url('technicalTraining/'.$techId) }}" data-toggle="tab">Technical Training</a></li>
...
@include('web.publicTraining.technicalCat')
					</div>
						</div>
...
//pagination
$(document).on('click', '#categorytech .pagination a', function(event){
 ...
 function fetch_data(page)
 {
  ...
  $.ajax({
    ...
    url:"{{ URL::to('fetch_tech') }}?page="+page,

   
   success:function(data)
   {
    $('#technicalList').html(data);
   }
  });
 }
