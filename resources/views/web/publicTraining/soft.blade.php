				...
				<div class="col-sm-12">
					...
					<div class="col-lg-2 col-md-4 col-sm-12">
						...
						<ul class="nav nav-tabs tabs-left sideways list-group">
							...
							<li class="active"><a href="{{ url('softTraining/'.$soft) }}" data-toggle="tab">Soft Skills Training</a></li>
...
<div id="softList">
@include('web.publicTraining.softCat')
					</div>
						</div>
...
//pagination
$(document).on('click', '#categorysoft .pagination a', function(event){
 ...
 function fetch_data(page)
 {
  ...
  $.ajax({
    ...
    url:"{{ URL::to('fetch_soft') }}?page="+page,
