			...
			<div class="row d-flex align-items-center justify-content-center">
				<div class="about-content col-lg-12">
					...
					<p class="text-color link-nav"><a href="{{ url('/') }}">Home </a> 
					 <span class="lnr lnr-arrow-right"></span>  <a > IT Training</a></p>
				</div>
			</div>
		</div>
	</section>
		...
		<div  class="container">
			<div class="row">
				<div class="col-sm-12">
                    ...
                    <div id="itList">
                      @include('web.publicTraining.itCat')
					</div>
						</div>
...
//pagination
$(document).on('click', '#itAll .pagination a', function(event){
