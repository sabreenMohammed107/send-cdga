				...
				<div class="col-sm-12">
					...
					<div class="col-lg-2 col-md-4 col-sm-12">
						...
						<ul class="nav nav-tabs tabs-left sideways list-group">
							<li class="active"><a href="{{ route('publicTraining') }}" data-toggle="tab">All Training</a></li>
                    ...
                    <div id="contentList">
                      @include('web.publicTraining.indexCat')
					</div>
						</div>
...
//pagination
$(document).on('click', '#categoryAll .pagination a', function(event){
 ...
 function fetch_data(page)
 {
  ...
  $.ajax({
    ...
    url:"{{ URL::to('fetch_main') }}?page="+page,
