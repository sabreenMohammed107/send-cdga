	...
	<div class="container mt-3">
		...
		<ul class="nav nav-tabs">
            ...
            <?php 
						...
						?>
			<li class="nav-item">
				<a class="nav-link" href="{{ url('calender/'.$current) }}">Training Calendar {{$current}}</a>
			</li>
			<li class="nav-item">
				<a class="nav-link active" href="{{ url('calenderNext/'.$next) }}">Training Calendar{{$next}}</a>
			</li>
		</ul>
		<style>
